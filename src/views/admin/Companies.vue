<template>
  ...
  <input type="text" class="rounded-full w-full mb-5 mt-5 bg-gray-200 border-none focus:outline-none placeholder-gray-500 font-body" placeholder="Search">
  <img
  ...
  <div class="flex gap-4 mt-6 items-center overflow-auto rounded-md shadow-md p-6 justify-center">
...
export default {
  ...
  setup() {
    ...
    const getCompanies = () => store.dispatch("getCompanies", {limit: limit.value, page: page.value});
