<template>
  ...
  <img
    ...
    alt=""
  />
 <!-- <table class="table min-w-full overflow-auto space-y-6 w-full shadow-md rounded-md text-gray-400 text-sm">
    <thead>
      <tr>
              ...
              <tr v-for="company in results.companies" :key="company.id">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="ml-4">
                      <div class="text-sm font-body font-medium text-primary-600 cursor-pointer">
                        {{ company.name }}
                      </div>
